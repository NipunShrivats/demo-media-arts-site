      ...
      <div className="about stiff-block">
        ...
        <div className="about-right">
          ...
          <p>
            ...
            with Founding Members – Mrs. Anil Prabha Anand (Chairman & Managing
            Director), Mr. Harsh Anand (Director, Publisher & Editor) & Mrs.
            Sucheta Anand (Managing Editor) onboard the panel, who efficiently
            commenced its business operation and pioneered the banner.
          </p>
          <br />
          <p>
            Today 'Sensationz Media & Arts Pvt. Ltd.' has full-fledgedly
            branched out with
          </p>
          <div>
            <ul>
